...
const Login = () => {
  ...
  // Common Input Style for Glass Look
  const glassInputStyle = {
    ...
    _focus: { bg: "rgba(255, 255, 255, 0.5)", borderColor: "white" }
  };
  ...
  return (
    <VStack spacing="15px">
      ...
      <Button
        bgGradient="linear(to-r, #f093fb, #f5576c)" // Funky Gradient
        color="white"
        width="100%"
        style={{ marginTop: 15 }}
        onClick={submitHandler}
        isLoading={loading}
        _hover={{ bgGradient: "linear(to-r, #d073db, #d5374c)", boxShadow: "lg" }}
      >
        Login
      </Button>
    </VStack>
